...
styles:
   - FC Bol Regular:
        ...
        characterset:
           ...
           Latin Extended-B: "Ə ƒ Ơ ơ Ư ư Ƶ Ǎ ǎ Ǧ ǧ ǻ Ǽ ǽ Ǿ ǿ ȃ Ș ș Ț ț ȷ"
           IPA Extensions: "ə"
           Spacing Modifier Letters: "ʻ ˆ ˇ ˉ ˘ ˙ ˚ ˛ ˜ ˝"
...
testers:
    ...
    - text: |
        ...
        Loại mây này hình thành khi không khí nóng bốc lên từ nguồn nhiệt mang theo hơi ẩm và các hạt nhỏ như tro bụi. Khi lên cao, không khí nguội dần, hơi ẩm ngưng tụ tạo thành mây. Do có nguồn gốc từ hiện tượng nhiệt cực đoan, mây Pyrocumulus thường chứa nhiều hạt bụi, tro, và đôi khi là khí độc hại. Chúng có thể xuất hiện độc lập hoặc kết hợp với các loại mây khác trong điều kiện thời tiết phức tạp.

        Mặc dù không phải lúc nào cũng gây ra thời tiết cực đoan, mây Pyrocumulus có thể dẫn đến giông, sét, và thậm chí là tạo điều kiện cho các cơn lốc xoáy nhỏ. Đặc biệt trong các trận cháy rừng lớn, sự hình thành của loại mây này có thể làm tăng thêm sức mạnh và sự lan rộng của ngọn lửa, gây khó khăn cho công tác cứu hỏa.
